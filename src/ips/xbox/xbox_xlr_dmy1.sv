...
assign bit_is_one_cnt = 
   host_regs[5][ 0] + host_regs[5][ 1] + host_regs[5][ 2] + host_regs[5][ 3] 
 + host_regs[5][ 4] + host_regs[5][ 5] + host_regs[5][ 6] + host_regs[5][ 7]
 + host_regs[5][ 8] + host_regs[5][ 9] + host_regs[5][10] + host_regs[5][11] 
 + host_regs[5][12] + host_regs[5][13] + host_regs[5][14] + host_regs[5][15] 
 + host_regs[5][16] + host_regs[5][17] + host_regs[5][18] + host_regs[5][19] 
 + host_regs[5][20] + host_regs[5][21] + host_regs[5][22] + host_regs[5][23] 
 + host_regs[5][24] + host_regs[5][25] + host_regs[5][26] + host_regs[5][27] 
 + host_regs[5][28] + host_regs[5][29] + host_regs[5][30] + host_regs[5][31] ;

always @(posedge clk or negedge rst_n)  begin 
  if (!rst_n) begin
      host_regs_data_out[6] <= 0 ;
      host_regs_valid_out[6] <= 0 ;
  end else begin
     if (host_regs_valid_pulse[5]) begin
       host_regs_data_out[6] <= bit_is_one_cnt ;
       host_regs_valid_out[6] <= 1 ;
     end
  end
end
